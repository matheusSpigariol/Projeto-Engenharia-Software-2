		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.JanelaDeCadastro.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		...
		SalvarButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(error == false) {
					JOptionPane.showMessageDialog(null, "Funcionário Cadastrado!", "Sucesso", JOptionPane.DEFAULT_OPTION);
					/*  Caso todos os dados estejam devidamente preenchidos o Funcionário será cadastrado.
					 * 	Podemos criar outras regras de verificação de dados, mas a priori são regras básicas.					 
					 * 	A partir das strings ExemploValue é possível apanhar os valores dos inputs.
					 * */
				} else {
